...
# 78 "umf4_f77wrapper.c" 2
# 128 "umf4_f77wrapper.c"
...
# 157 "umf4_f77wrapper.c"
void umf4def_ (double Control [20])
{
...
void umf4pcon_ (double Control [20])
{
    fflush (stdout) ;
...
{
    Control [7] = 0 ;
    (void) umfpack_di_solve (*sys, (int *) 0, (int *) 0, (double *) 0,
...
void umf4pinf_ (double Control [20], double Info [90])
{
    fflush (stdout) ;
...
# 338 "umf4_f77wrapper.c"
void umf4def (double Control [20])
{
    umfpack_di_defaults (Control) ;
}
...
void umf4pcon (double Control [20])
{
    fflush (stdout) ;
    umfpack_di_report_control (Control) ;
    fflush (stdout) ;
...
void umf4pinf (double Control [20], double Info [90])
{
    fflush (stdout) ;
    umfpack_di_report_info (Control, Info) ;
    fflush (stdout) ;
