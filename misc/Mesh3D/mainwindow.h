...
private slots:
  ...
  void flatShadeSlot();           // Mesh -> Shade model -> flat
  void smoothShadeSlot();         // Mesh -> Shade model -> smooth
...
private:
  ...
  QAction *hidesurfacemeshAct;    // Mesh -> Show surface mesh...
  QAction *hidesharpedgesAct;     // Mesh -> Show sharp edges...
  QAction *hideselectedAct;       // Mesh -> Show selected...
  QAction *flatShadeAct;          // Mesh -> Shade model -> Flat
  QAction *smoothShadeAct;        // Mesh -> Shade model -> Smooth
