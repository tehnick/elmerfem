...
public:
  ...
  void errMsg(int err_level, char* str1, const char* str2 = NULL, char* str3 = NULL, char* str4 = NULL);
...
protected:
  ...
  static int from_tk_DoMatc(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_AcceptEmfParameters(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_BodySelected(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_BoundarySelected(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_BoundariesSelected(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_CheckMeshCornerElements(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_CheckModelStatus(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ColorHex2Name(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_CombineBoundaries(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_CopyParameters(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_CorrectMeshZeroVelocityElements(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_DoBreak(ClientData, Tcl_Interp*, int, const char**);

  static int from_tk_Exit(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_LoadMesh(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_OpenCadFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_OpenMeshFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_OpenModelFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ProcessExists(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ProcessResume(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ProcessSetPriorityLevel(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ProcessStart(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ProcessStop(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ProcessSuspend(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_PutModelStatusMessage(ClientData, Tcl_Interp*, int, const char**);
  // Read parameters
  static int from_tk_ReadBodyForceData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBodyParameterData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundariesData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundaryConditionData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundaryConditionsForEdges(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundaryConditionsForFaces(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundaryConditionsForVertices(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundaryParameterData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadCalculatorData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadColorFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadConstantData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadCoordinateData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadDatafileData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadEquationData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadEquationVariablesData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadGridHData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadGridParameterData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadInitialConditionData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadMatcFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadMaterialData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadMeshDefineData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadModelParameterData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadSimulationParameterData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadSolverData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadSolverControlData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadTimestepData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadUserSettingsData(ClientData, Tcl_Interp*, int, const char**);
  // Read converteed older version data
  static int from_tk_ReadConvertedEquationData(ClientData, Tcl_Interp*, int, const char**);
  // Read other
  static int from_tk_ReadActiveMeshIndices(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBodyColors(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBodyDeleteData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBodyData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBodyDisplayData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundaryDisplayData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBoundaryNames(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadBodyNames(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadDeletedParamIds(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadModelFileCreated(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadModelFileModified(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadModelFileTime(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadModelHasUserDefinitions(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadModelPropertyData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadProcessorData(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadSelectionTolerances(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadTimestamp(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ReadUserSettingFiles(ClientData, Tcl_Interp* interp, int, const char**);
  static int from_tk_ReadVertexDisplayData(ClientData, Tcl_Interp*, int, const char**);
  //
  static int from_tk_RemoveCadGeometry(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RendererDisplayModel(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RendererResetModel(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RendererRotateModel(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RendererScaleModel(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RendererSetEditBoundaries(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RendererSetRotatePriorities(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RendererTranslateModel(ClientData, Tcl_Interp*, int, const char**);

  static int from_tk_ResetBoundarySelections(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_RestoreBoundaryNames(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_ResetAllBoundarySelections(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SaveElmerMeshFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SaveElmerPostMeshFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SaveModelFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SaveMeshInputFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SaveSolverInputFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SaveThetisMeshFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SaveUserSettingsFile(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SelectMeshBoundaryElements(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SetCurrentDirectory(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SetFlagValue(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SetMatcInputFileEmf(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SetMatcInputFileSif(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SetMeshInputUnit(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SetModelStatus(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SetSelectionsToGui(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SplitBoundary(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SplitCombineBoundariesRedo(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_SplitCombineBoundariesUndo(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_StopEditMeshBoundaries(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_StoreBoundaryNames(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_UnloadMesh(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_UpdateCadGeometry(ClientData, Tcl_Interp*, int, const char**);
  static int from_tk_UpdateMatcFile(ClientData, Tcl_Interp*, int, const char**);
