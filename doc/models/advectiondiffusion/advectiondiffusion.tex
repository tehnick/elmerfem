...
explained elsewhere.
\sifbegin
\sifitem{Equation}{String [Advection Diffusion Equation Varname]}
...
\sifbegin
\sifitem{Advection Diffusion Equation Varname}{Logical} If set to {\tt True}, solve the advection-diffusion equation.
...
\sifbegin
\sifitem{Varname Diffusion Source}{Real}
...
in constant volume.
\sifitem{Varname Diffusivity}{Real}
...
\sifitem{Varname Flux}{Real} A user defined mass flux term in absolute
...
coefficient bc.
\sifitem{Varname Solubility Change Boundary}{Logical True}
