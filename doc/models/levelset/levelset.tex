...
\sifbegin
\sifitem{LevelSet Velocity i}{Real}
The velocity field that advects the level-set function. In 2D \texttt{i=1,2} and in 3D 
\texttt{i=1,2,3}. This may be a constant field or also 
