...
\]
where $\sigma$ is the electric conductivity. In time-harmonic case 
...
If this flag is active the Heat equation will automatically include the computed Joule 
heating as a heat source.
Then it is assumed that Joule heating field is named $\phi$ is named \texttt{Joule field}.
...
The electric conductivity defines the relation $\vec{\jmath}=\sigma \vec{E}$.
