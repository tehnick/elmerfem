...
\modinfo{Module authors}{Erik Edelmann, Mikko Lyly}
...
The choices are \texttt{gid, vtk}, and \texttt{dx}. 
...
solution type. 
\sifend
The following keywords related only to the GiD format. In other formats all available 
degrees of freedom are saved. 
\sifbegin
\sifitem{Scalar Fields i}{String}
The scalar fields to be saved, for example \texttt{Pressure}. 
Note tha the fields must be numbered continously starting from one.
\sifitem{Scalar Fields i}{String}
