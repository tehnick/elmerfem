...
\begin{figure}[h]
\centerline{ \includegraphics[width=2in]{3node_tri.ps}\ \ \ \ \includegraphics[width=2in]{6node_tri.ps} }
...
\begin{figure}[h]
\centerline{ \includegraphics[width=2in]{4node_quad.ps}\ \ \ \ \includegraphics[width=2in]{8node_quad.ps} }
...
\begin{figure}[h]
\centerline{ \includegraphics[width=2in]{4node_tetra.ps}\ \ \ \ \includegraphics[width=2in]{10node_tetra.ps} }
...
\begin{figure}[h]
\centerline{ \includegraphics[width=2in]{8node_brick.ps}}
\centerline{ \includegraphics[width=2in]{20node_brick.ps}}
