...
end. On the other end its subjected with a load of 2000~N
...
Problem is to solve the displacement and stress field of the beam.  
Problem is solved according to the linear theory of elasticity assuming linear isotropic material law. 
...
Model
  BodyForce
    ...
    OK
\ttend
Note that the body force is automatically multiplied by the density hence only acceleration of
gravity needs to be given.
...
The maximum displacement is $6.33$~cm 
