...
does not need knownledge about the different modules but it may be of use if the user wants to setup
...
This file is read by ElmerSolver in case no command line parameter defining the 
