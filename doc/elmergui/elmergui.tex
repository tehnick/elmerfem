...
As ElmerGUI is based on Qt4, it is relatively easy to customize the menus
of the main window. A new menu item, for example, is added as follows.
...
It finally remains to define the slot to which the action is connected
when triggered. All processing related to the action should be done here:
\begin{verbatim}
...
(declared in {\tt src/meshtype.h}). It is private to the class {\tt GLWidget}
