...
\noindent The console provides access to the ``public slots'' of the following C++ classes:
\begin{footnotesize}
\begin{verbatim}
...
\end{verbatim}
\end{footnotesize}
Each of these classes provides a number of useful methods for data and display
manipulation. To fix ideas, the following sequence of commands will read in the
result file and draws the ``Temperature'' field as a surface plot. More examples
can be found in section N.N.
\begin{footnotesize}
\begin{verbatim}
