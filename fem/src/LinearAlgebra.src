...
!/*******************************************************************************
! *
! * Linear Algebra: LU-Decomposition & matrix inverse & nonsysmmetric full matrix
! * eigenvalues  (don't use this for anything big, use for example LAPACK routines
! * instead...)
! *
! *******************************************************************************
! *
...
CONTAINS
    ...
    SUBROUTINE Francis( H, dim )
      ...
      REAL(KIND=dp) :: x(3), v(3), b, s, t, bv, v0i
