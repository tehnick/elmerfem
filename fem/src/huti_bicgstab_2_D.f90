...
!
! $Id: huti_bicgstab_2_D.f90,v 1.3 2002/02/14 09:31:26 apursula Exp $
...
subroutine  huti_ddbicgstab_2solv  ( ndim, wrkdim, xvec, rhsvec, &
...
end subroutine  huti_ddbicgstab_2solv 
