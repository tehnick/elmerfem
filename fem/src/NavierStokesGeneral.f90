...
!/*******************************************************************************
! *
! *  Module computing Navier-stokes local matrices (general coordinates)
! *
! *******************************************************************************
! *
     ...
     IF ( NewtonLinearization ) THEN
       DO i=1,dim
         DO j=1,dim
           ...
           IF ( CurrentCoordinateSystem() /= Cartesian ) THEN
             DO k=1,dim
               Force(i) = Force(i) + Symb(k,j,i) * Velo(k) * Velo(j)
             END DO
           END IF
         END DO
       END DO
...
DLLEXPORT NavierStokesGeneralBoundary
!------------------------------------------------------------------------------
!******************************************************************************
!
!  Return element local matrices and RSH vector for Navier-Stokes-equations
