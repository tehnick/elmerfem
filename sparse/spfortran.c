...
static char RCSid[] =
    "@(#)$Header: /fs/proj1/elmer/elmersrc/sparse/spfortran.c,v 1.3 1999/12/13 15:18:40 jpr Exp $";
#endif
...
#define sfWhereSingular         SFWHERESINGULA
...
void sfZeroRow( Matrix, Row )
long *Matrix;
int  *Row;
{
/* Begin `spZeroRow'. */
    spZeroRow( (char *)*Matrix, *Row );
}
