...
static char RCSid[] =
    "@(#)$Header: /fs/proj1/elmer/elmersrc/sparse/spfactor.c,v 1.3 2000/02/15 14:24:30 jpr Exp $";
#endif
...
ElementPtr spcFindElementInCol(MatrixPtr,ElementPtr *,int,int,int);
...
ElementPtr  spcCreateElement(MatrixPtr,int,int,ElementPtr *,int);
...
fprintf( stderr, "zero pivot: %d\n", Matrix->IntToExtRowMap[Step] );
    Matrix->SingularRow = Matrix->IntToExtRowMap[ Step ];
    Matrix->SingularCol = Matrix->IntToExtColMap[ Step ];
